class Memory {
    ...
    // copies "size" boxes of data from the "from" pointer to the "to"
    // pointed (for example, copy (10, 0, 3) would coyp the values 
    // at boxes 0, 1, and 2 to the boxes at 10, 11 and 12 respectively)
    ...
    // sets the value at a certain memory address
    set(ptr, value) {
